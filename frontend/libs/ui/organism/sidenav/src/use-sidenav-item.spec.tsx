...
describe('compendium.frontend.test.utils:side-nav-item', function () {
  // const mockState: any = {
  //   selectionManager: {
  ...
  // const renderSideNavItemHook = (
  //   menuProps: SpectrumSideNavItemProps<unknown>,
  //   itemProps: any = {}
  // ) => {
  //   const item = {
  //     key: '1',
  //     ...itemProps
  //   };
  //   const { result } = renderHook(() => useSideNavItem({ ...menuProps, item }, mockState));
  //   return result.current;
  // };

  it('returns default aria for navigation item', function () {
    // TODO update for preact
    // const { listItemProps, listItemLinkProps } = renderSideNavItemHook({});
  ...
  it('returns aria for selected item', function () {
    // TODO update for preact
    // const { listItemProps, listItemLinkProps } = renderSideNavItemHook({}, { key: 'selected' });
    // expect(listItemProps).toBeDefined();
    // expect(listItemProps.role).toBe('listitem');
    // expect(listItemLinkProps).toBeDefined();
    // expect(listItemLinkProps.role).toBe('link');
